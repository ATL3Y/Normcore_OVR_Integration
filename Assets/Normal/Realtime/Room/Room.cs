...
namespace Normal.Realtime {
    public class Room {
        ...
        // Connect / Disconnect
        public void Connect(string roomName, string appKey, IModel roomModel) {
            if (!sessionCapturePlayback) {
        ...
        private void ConnectToServer(string roomName, string appKey, IModel roomModel) {
            ...
            // Once the matcher does its thing, we'll have the serverAddress/serverPort needed to connect
            // TODO: Fix "FakeToken" before shipping!!
        ...
        private void StartSessonCapturePlayback(IModel roomModel) {
            // Reset datastore
